...
review_status: P1_PENDING_CI_AND_HUMAN_REVIEW
ci_run: null
...
lessons_validated:
  ...
  - LESSON-RCRM-0006
  - LESSON-RCRM-0007
next_action: PUSH_P1_HARNESS_AND_AWAIT_CI
...
dados. O harness `test:migration-compat` está pronto para provar os cenários A/B
no GitHub Actions, que será a evidência autoritativa. TASK-04 continua
bloqueada, `next_eligible_task` permanece `PILOT_AUDIT` e o modo segue
`SUPERVISED_PILOT`.
